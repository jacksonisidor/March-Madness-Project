...
class BracketSimulator: 
    ...
    def __init__(self, data, year, boldness="Normal", picked_winner=None, playstyle="Balanced"):
        self.data = data
        self.year = year
...
simulator = BracketSimulator(data=data, year=2024)

simulated_bracket = simulator.sim_bracket()

print(simulated_bracket[simulated_bracket.current_round == 64][["team_1", "team_2", "prediction", "win probability"]])
print("----------------------------------------------------")
print(simulated_bracket[simulated_bracket.current_round == 32][["team_1", "team_2", "prediction", "win probability"]])
print("----------------------------------------------------")
print(simulated_bracket[simulated_bracket.current_round == 16][["team_1", "team_2", "prediction", "win probability"]])
print("----------------------------------------------------")
print(simulated_bracket[simulated_bracket.current_round == 8][["team_1", "team_2", "prediction", "win probability"]])
print("----------------------------------------------------")
print(simulated_bracket[simulated_bracket.current_round == 4][["team_1", "team_2", "prediction", "win probability"]])
print("----------------------------------------------------")
print(simulated_bracket[simulated_bracket.current_round == 2][["team_1", "team_2", "prediction", "win probability"]])
